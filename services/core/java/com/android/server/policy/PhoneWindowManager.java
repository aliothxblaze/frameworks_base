...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    void updateSettings(Handler handler) {
        ...
        // Double-tap-to-doze
        mDoubleTapToWake = Settings.Secure.getInt(resolver, Settings.Secure.DOUBLE_TAP_TO_WAKE, 0) == 1;
        mDoubleTapToDoze = Settings.System.getInt(resolver, Settings.System.DOZE_TRIGGER_DOUBLETAP, 0) == 1;
